...
import ru.emeltsaykin.decomposelazylist.components.kitten.KittenComponent.Model
...
class DefaultKittenComponent(
    ...
    private class Handler(initialState: State) : InstanceKeeper.Instance {
        ...
        fun resume() {
            ...
            disposable = observableInterval(period = 250.milliseconds, scheduler = mainScheduler).subscribe {
