...
class ChildLazyListsChangeLastVisibleIndexTest : BaseChildLazyListsTest() {
    ...
    @Test
    fun GIVEN_5_lazy_list_items_and_visible_indexes_0_2_WHEN_change_last_visible_index_0() {
    ...
    @Test
    fun GIVEN_5_lazy_list_items_and_visible_indexes_1_2_WHEN_change_last_visible_index_0_THEN_exception() {
        ...
        assertFailsWith(
            ...
            "The lastVisibleIndex argument must be greater than firstVisibleIndex: 1. Actual: 0."
        ) { navigation.changeLastVisibleElementIndex(index = 0) }
    }

    @Test
    fun GIVEN_5_lazy_list_items_and_visible_indexes_1_2_WHEN_change_last_visible_index_2() {
        val lazyLists by context.childLazyLists(
            initialPages = LazyLists(
                items = listOf(0, 1, 2, 3, 4),
                firstVisibleIndex = 1,
    ...
    @Test
    fun GIVEN_5_lazy_list_items_and_visible_indexes_1_2_WHEN_change_last_visible_index_1() {
        val lazyLists by context.childLazyLists(
            initialPages = LazyLists(
                items = listOf(0, 1, 2, 3, 4),
                firstVisibleIndex = 1,
